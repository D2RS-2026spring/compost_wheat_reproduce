...
### 1. 数据可用性
*   数据可以公开可获取
*   具体位置/格式：在GitHub仓库中，为xlsx格式

### 2. 代码可用性
*   代码可以公开可获取
*   具体位置/格式：在GitHub仓库根目录，为R脚本

### 3. 环境可重建性
 *   未提供了环境描述文件
 *   复现过程：使用 renv::restore() 命令，将整个仓库克隆到我的项目文件夹中，手动安装所需R包

### 4. 结果可重复性
*   **复现结果**：
    *  举例如下：

<img width="1923" height="951" alt="Image" src="https://github.com/user-attachments/assets/075ebc1c-6c65-4a25-9343-5b2ba5051589" />

*   **详细说明**：
    *   代码在配置好renv环境后可以顺利运行，生成了图片，其数值与论文中的图一致
## 复现说明
